...
- Timestamp: `2022-06-08 11:33`
- Build ID: `b1ec3da5-574b-49b3-afee-baf5aa87ca9b`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b1ec3da5-574b-49b3-afee-baf5aa87ca9b.git
$ cd b1ec3da5-574b-49b3-afee-baf5aa87ca9b
```
